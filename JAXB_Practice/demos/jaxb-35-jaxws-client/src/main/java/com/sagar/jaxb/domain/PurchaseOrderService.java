 ...
 * 
 */
@WebServiceClient(name = "PurchaseOrderService", targetNamespace = "http://www.sagar.com/jaxb", wsdlLocation = "http://localhost:8080/po?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PURCHASEORDERSERVICE_QNAME = new QName("http://www.sagar.com/jaxb", "PurchaseOrderService");
    ...
    public PurchaseOrders getPurchaseOrderPort() {
        return super.getPort(new QName("http://www.sagar.com/jaxb", "PurchaseOrderPort"), PurchaseOrders.class);
    }
    ...
    public PurchaseOrders getPurchaseOrderPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.sagar.com/jaxb", "PurchaseOrderPort"), PurchaseOrders.class, features);
    }
